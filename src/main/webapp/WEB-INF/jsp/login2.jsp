...
<div id="header" class="wrap">
        ...
        <div class="help"><a href="#" class="shopping">购物车</a><a href="login">登录</a><a href="register.html">注册</a><a href="guestbook.html">留言</a></div>
        <div class="navbar">
                <ul class="clearfix">
                                ...
                                <table>
                                        ...
                                        <tr>
                                                ...
                                                <td><label class="ui-green"><input type="submit" name="submit" value="立即登录" /></label>
                                                        ...
                                                        <label style="color:red;font-size:14px;">${MSG}</label>
                                                </td>
                                        </tr>
                                </table>
                        </form>
