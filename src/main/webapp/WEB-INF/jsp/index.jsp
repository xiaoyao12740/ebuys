...
<div id="header" class="wrap">
    ...
    <div class="help">
        <c:if test="${sessionScope.USERS==null}">
            <a href="#" class="shopping">购物车</a><a href="login">登录</a><a href="register.html">注册</a>
            <a href="guestbook.html">留言</a>
        </c:if>
        <c:if test="${sessionScope.USERS!=null}">
            <a href="#" class="shopping">购物车</a>欢迎您：${sessionScope.USERS.eu_user_name}
    ...
    <div class="lefter">
        <div class="box">
            ...
            <dl>
                ...
                <c:forEach items="${mapCategroy}" var="m">
                    <dt>${m.key}</dt>
                    <c:forEach items="${m.value}" var="mv">
                        <dd><a href="selectProductByCategory?eid=${mv.id}&page=1">${mv.epc_name}</a></dd>
                    </c:forEach>
                </c:forEach>
    ...
    <div class="main">
        ...
        <div class="side">
            <div class="news-list">
                <h4>最新公告</h4>
                <ul>
                    <c:forEach items="${list1}" var="news" end="6">
            ...
            <div class="news-list">
                <h4>新闻动态</h4>
                <ul>
                    <c:forEach items="${list2}" var="news" end="6">
                        <li><a href="getNewsById?newsId=${news.id}" target="_blank">${news.en_title}</a></li>
                    </c:forEach>
                </ul>
            </div>
        ...
        <div class="hot">
            ...
            <ul class="product clearfix">
                ...
                <c:forEach items="${listRmtj}" var="p">
                    <li>
                        <dl>
                            <dt><a href="product-view?id=${p.id}" target="_blank"><img src="${p.ep_file_name}" /></a></dt>
                            <dd class="title"><a href="product-view?id=${p.id}" target="_blank">${p.ep_name}</a></dd>
